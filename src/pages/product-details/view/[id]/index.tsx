...
import { getProductDetailsById } from 'apiSdk/product-details';
import { ProductDetailsInterface } from 'interfaces/product-details';

function ProductDetailsViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('product_details', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/product-details/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Product Summary" text={data?.product_summary} />
