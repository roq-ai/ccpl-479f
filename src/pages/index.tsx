  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="CCPL - A Dynamic Web Application: Offering a variety of products, showcasing customer testimonials, and providing a user-friendly contact form. Explore our products, discover our company branches, and let us capture your details seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1460925895917-afdab827c52f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3ZWIlMjBhcHBsaWNhdGlvbnxlbnwwfHx8fDE2OTU3MTI0NjB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`CCPL - A Dynamic Web Application: Offering a variety of products, showcasing customer testimonials, and providing a user-friendly contact form. Explore our products, discover our company branches, and let us capture your details seamlessly.`}
            </Text>
            <Box
