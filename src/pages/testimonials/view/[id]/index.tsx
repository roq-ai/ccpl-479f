...
import { getTestimonialById } from 'apiSdk/testimonials';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('testimonial', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/testimonials/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Client Image" text={data?.client_image} />

                <FormListItem label="Client Name" text={data?.client_name} />

                <FormListItem label="Client Profession" text={data?.client_profession} />
              </List>
            </FormWrapper>
          </>
        )}
