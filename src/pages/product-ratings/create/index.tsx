...
import { createProductRating } from 'apiSdk/product-ratings';
...
function ProductRatingCreatePage() {
  ...
  const handleSubmit = async (values: ProductRatingInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createProductRating(values);
      resetForm();
