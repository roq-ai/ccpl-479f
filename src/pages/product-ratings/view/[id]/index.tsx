...
import { getProductRatingById } from 'apiSdk/product-ratings';
import { ProductRatingInterface } from 'interfaces/product-rating';

function ProductRatingViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('product_rating', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/product-ratings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Rating Comment" text={data?.rating_comment} />

                <FormListItem label="Rating Given By" text={data?.rating_given_by} />

                <FormListItem label="Rating Given Email" text={data?.rating_given_email} />
              </List>
            </FormWrapper>
          </>
        )}
