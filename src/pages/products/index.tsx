...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProducts({
        relations: [, 'product_details.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['product_description.contains', 'product_manager.contains', 'product_manager_mobile.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'product_manager', header: 'Product Manager', accessorKey: 'product_manager' },
    { id: 'product_manager_mobile', header: 'Product Manager Mobile', accessorKey: 'product_manager_mobile' },
    hasAccess('product_details', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'product_details',
          header: 'Product Details',
          accessorKey: 'product_details',
          cell: ({ row: { original: record } }: any) => record?._count?.product_details,
        }
      : null,
