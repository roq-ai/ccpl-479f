...
import { ProductDetailsListPage } from 'pages/product-details';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Product Manager" text={data?.product_manager} />

                <FormListItem label="Product Manager Mobile" text={data?.product_manager_mobile} />
              </List>
            </FormWrapper>
