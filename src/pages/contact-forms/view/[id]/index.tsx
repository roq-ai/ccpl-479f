            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('contact_form', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/contact-forms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Mobile Number" text={data?.mobile_number} />

                <FormListItem label="Name" text={data?.name} />

                <FormListItem label="Company Name" text={data?.company_name} />

                <FormListItem label="Contact Reason" text={data?.contact_reason} />
              </List>
            </FormWrapper>
          </>
        )}
